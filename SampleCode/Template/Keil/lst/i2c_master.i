...
void I2Cx_MasterRx_multi(uint32_t u32Status)
{
    if(u32Status == (0x08)) 
    {
        (((((I2C_T *) ((( uint32_t)0x40000000) + 0x80000))))->DAT = (((g_u8DeviceAddr_m << 1) | (0x00))));    				 
        (((((I2C_T *) ((( uint32_t)0x40000000) + 0x80000))))->CTL0 = (((((I2C_T *) ((( uint32_t)0x40000000) + 0x80000))))->CTL0 & ~0x3C) | (0x08UL));

		I2Cx_Master_LOG(u32Status);
    }
    else if(u32Status == (0x18)) 
    {
        (((((I2C_T *) ((( uint32_t)0x40000000) + 0x80000))))->DAT = (g_au8Reg));
        (((((I2C_T *) ((( uint32_t)0x40000000) + 0x80000))))->CTL0 = (((((I2C_T *) ((( uint32_t)0x40000000) + 0x80000))))->CTL0 & ~0x3C) | (0x08UL));
    ...
    {
        (((((I2C_T *) ((( uint32_t)0x40000000) + 0x80000))))->CTL0 = (((((I2C_T *) ((( uint32_t)0x40000000) + 0x80000))))->CTL0 & ~0x3C) | (0x08UL | 0x20UL | 0x10UL));
    ...
    {
        if (rawlenth > 0)
			(((((I2C_T *) ((( uint32_t)0x40000000) + 0x80000))))->CTL0 = (((((I2C_T *) ((( uint32_t)0x40000000) + 0x80000))))->CTL0 & ~0x3C) | (0x08UL | 0x20UL));				
		else
		{
			(((((I2C_T *) ((( uint32_t)0x40000000) + 0x80000))))->CTL0 = (((((I2C_T *) ((( uint32_t)0x40000000) + 0x80000))))->CTL0 & ~0x3C) | (0x08UL | 0x10UL));
			g_u8EndFlag = 1;
		}
    ...
    {
        (((((I2C_T *) ((( uint32_t)0x40000000) + 0x80000))))->DAT = (((g_u8DeviceAddr_m << 1) | (0x01))));   		 
        (((((I2C_T *) ((( uint32_t)0x40000000) + 0x80000))))->CTL0 = (((((I2C_T *) ((( uint32_t)0x40000000) + 0x80000))))->CTL0 & ~0x3C) | (0x08UL));
    ...
    {
		if (rawlenth > 1)
			(((((I2C_T *) ((( uint32_t)0x40000000) + 0x80000))))->CTL0 = (((((I2C_T *) ((( uint32_t)0x40000000) + 0x80000))))->CTL0 & ~0x3C) | (0x08UL | 0x04UL));
		else
			(((((I2C_T *) ((( uint32_t)0x40000000) + 0x80000))))->CTL0 = (((((I2C_T *) ((( uint32_t)0x40000000) + 0x80000))))->CTL0 & ~0x3C) | (0x08UL));
    ...
    {
        g_au8Buffer[g_u8DataLen_m++] = (unsigned char) I2C_GetData((((I2C_T *) ((( uint32_t)0x40000000) + 0x80000))));
...
void I2Cx_MasterTx_multi(uint32_t u32Status)
{
    ...
    else if(u32Status == (0x28)) 
    {
        ...
        {
            (((((I2C_T *) ((( uint32_t)0x40000000) + 0x80000))))->DAT = (g_au8Buffer[g_u8DataLen_m++]));
            (((((I2C_T *) ((( uint32_t)0x40000000) + 0x80000))))->CTL0 = (((((I2C_T *) ((( uint32_t)0x40000000) + 0x80000))))->CTL0 & ~0x3C) | (0x08UL));
        }
        else
        {
    ...
    {
		(((((I2C_T *) ((( uint32_t)0x40000000) + 0x80000))))->CTL0 = (((((I2C_T *) ((( uint32_t)0x40000000) + 0x80000))))->CTL0 & ~0x3C) | (0x2CUL));

		I2Cx_Master_LOG(u32Status);		
    }
    else if(u32Status == (0x00)) 
    {
		(((((I2C_T *) ((( uint32_t)0x40000000) + 0x80000))))->CTL0 = (((((I2C_T *) ((( uint32_t)0x40000000) + 0x80000))))->CTL0 & ~0x3C) | (0x1CUL));
...
{		
	...
	(((((I2C_T *) ((( uint32_t)0x40000000) + 0x80000))))->CTL0 = (((((I2C_T *) ((( uint32_t)0x40000000) + 0x80000))))->CTL0 & ~0x3C) | (0x20UL));
